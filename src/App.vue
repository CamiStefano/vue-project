...
<template>
  ...
  <h2>{{ activo ? "estoy activo con operador ternario" : " estoy activo con operador ternario" }}</h2>
  <p v-if="activo === true">
    <span>Icono</span>
    Estoy activo
  </p>
  ...
  <ul>
    <li v-for="(value, propiedad, i) in objetoFruta" key="value">{{ i }} - {{ propiedad }}: {{ value }}</li>
  </ul>
</template>
